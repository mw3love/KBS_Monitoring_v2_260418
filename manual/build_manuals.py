...
def build_full_manual():
    ...
    sens = [
        ...
        ("임베디드 오디오 감지 (무음 감지)", [
            ...
            ("알람 발생 기준 (초)", "무음이 이 시간 이상 지속되면 알람 (기본 60초)"),
        ]),
    ]
    ...
    faqs = [
        ...
        ("Q. 알람이 너무 자주 발생하거나 오감지가 많습니다.",
         "감도설정 탭에서 알람 발생 기준 시간을 늘리거나(예: 블랙 5초 → 15초), "

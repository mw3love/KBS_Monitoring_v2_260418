...
- **임베디드 오디오 입력 장치** 드롭다운 (sounddevice 장치 목록, 이름 기반 저장. 기본=시스템 기본 입력) ※ v2 신규
...
| audio_input_device | "" | - | sounddevice 장치 이름 (""=기본) |
...
| audio_input_device | "" | - | sounddevice 장치 이름 (""=시스템 기본) |
...
- **임베디드 오디오 입력 장치 선택 UI** (신규, 다중 장치 환경 대응, 이름 기반 저장)

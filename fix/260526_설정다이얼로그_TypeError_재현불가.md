...
> **상태**: **5건 발생** (260526, 260620, 260706, 260711, 260724). 코드 버그 아님 — UI 프로세스 국소 런타임 손상 확정.
> **최신은 §13-7 (5차 + Round 1 부결 + Round 2 배포 준비·dev PC 검증 완료, 운영 배포는 승인 대기)**. 여기부터 읽는 게 빠르다.

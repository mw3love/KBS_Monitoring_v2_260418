...
> 마지막 업데이트: 2026-07-25 (v2.8.6 — W17 UI 장기가동 손상 5차 대응: Round 1 부결 확정 + Round 2 배포 준비·dev PC 검증 완료 + 기동 알림(텔레그램·화면 로그) + UI 손상 시 화면 로그 best-effort + python313_전환.bat 한글깨짐 견고화(운영 PC 재발 대응))

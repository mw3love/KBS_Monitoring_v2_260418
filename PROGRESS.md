...
> 마지막 업데이트: 2026-07-26 (v2.8.7 — 기동 알림 미발송 사유 로깅 + 앱 버전 단일출처화. 설정파일 이월이 원인이라는 §13-8 추정은 반증됨 → §13-9)
...
> ✅ **판정 완료 (2026-08-07)**: W17 Round 2(Python 3.13 다운그레이드) — **재발 없음 확정**. 2026-07-25 12:01 배포 후 08-07까지 13일 무재시작(과거 최장 생존 5.48일의 2.4배) — 운영 PC 로그 전수 검토로 재시작 0회·재spawn 0회·손상통보 0회·ERROR 0건 확인. 상세: `fix/260526_설정다이얼로그_TypeError_재현불가.md` §13-10.

...
> 마지막 업데이트: 2026-07-13 (v2.8.0 — W17 UI 장기가동 손상 4차 대응: 즉시 통보 + Round 1 제거 실험)
...
> ⏳ **관찰 중**: W17 Round 1 제거 실험 — 배포 후 ~7일 무사하면 arm 3개 중 하나가 범인, 또 ~5일에 죽으면 Round 2(Python 3.13). 판정 전까지 **예약 재시작 OFF 유지 필수**.

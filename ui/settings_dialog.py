...
class SettingsDialog(QDialog):
    ...
    def _build_tab_alert(self) -> QScrollArea:
        ...
        sys_chat_vl.setContentsMargins(0, 0, 0, 0)
        sys_chat_vl.setSpacing(3)
        sys_chat_vl.addWidget(sys_chat_lbl)
        sys_chat_vl.addWidget(self._tg_sys_chat_edit)
        sl3.addLayout(sys_chat_vl)
        ...
        self._tg_signoff_cb = QCheckBox("정파 진입/해제 알림")
    ...
    def _build_tab_save(self) -> QWidget:
        ...
        lbl_ver = QLabel("KBS On-Air Monitoring v2.8.12")
        lbl_ver.setObjectName("aboutCardVersion")
        about_vl.addWidget(lbl_ver)

        lbl_meta = QLabel("날짜: 2026-08-07    제작: minwoo@kbs.co.kr")
    ...
    def _collect_config(self):
        ...
        tg["system_chat_id"] = self._tg_sys_chat_edit.text().strip()
        ...
        tg["notify_signoff"] = self._tg_signoff_cb.isChecked()
